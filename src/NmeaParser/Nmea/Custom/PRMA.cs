...
namespace NmeaParser.Messages
{
    ...
    /// </remarks>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Prma")]
    [NmeaMessageType("PRMA")]
    public class Prma : NmeaMessage, IGeographicLocation
    {
        /// <summary>
        ...
        public Prma(string type, string[] message) : base(type, message)
        {
